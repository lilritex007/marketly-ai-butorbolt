        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-5 max-w-5xl mx-auto px-2">
            {[
              ...
              >
                <stat.icon className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 text-indigo-600 mx-auto mb-2 lg:mb-3" />
    ...
    <div className="py-10 sm:py-12 lg:py-14 bg-gradient-to-b from-white to-gray-50">
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-8 sm:mb-10 lg:mb-12">
          <div className="inline-flex items-center px-4 py-2 sm:px-5 sm:py-2.5 bg-indigo-100 rounded-full mb-5 lg:mb-6">
            <Sparkles className="w-5 h-5 sm:w-5 sm:h-5 text-indigo-600 mr-2" />
            <span className="text-base sm:text-lg font-bold text-indigo-600">AI Powered Features</span>
          </div>
            ...
            >
              ...
              <div className="relative bg-white rounded-xl lg:rounded-2xl p-5 sm:p-6 lg:p-7 shadow-xl border border-gray-100 hover:shadow-2xl transition-all">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-base sm:text-lg font-bold text-indigo-600">{feature.stats}</span>
                  <ArrowRight className={`w-5 h-5 sm:w-5 sm:h-5 text-gray-400 group-hover:text-indigo-600 group-hover:translate-x-1 transition-all`} />
                </div>
          ...
          {features.map((_, idx) => (
            <button
              ...
              className={`h-2.5 rounded-full transition-all ${
                activeFeature === idx ? 'w-10 sm:w-12 bg-indigo-600' : 'w-2.5 bg-gray-300'
              }`}
            />
          ))}
        </div>
